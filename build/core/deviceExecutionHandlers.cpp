...
const size_t COPC_UA_Local_Handler::mHandlerIdentifier = 2;
const size_t COPC_UA_Remote_Handler::mHandlerIdentifier = 3;
...
void CDeviceExecution::createHandlers(CDeviceExecution& paDeviceExecution){
  ...
  paDeviceExecution.mRegisteredEventHandlers[2].mHandler = new COPC_UA_Local_Handler(paDeviceExecution);
  paDeviceExecution.mRegisteredEventHandlers[3].mHandler = new COPC_UA_Remote_Handler(paDeviceExecution);
